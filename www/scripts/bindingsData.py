...
hotasDetails = {
    ...
    '231D0126': { # VKB Kosmosima SCG Right
        ...
        'Joy_16': {'Type': 'Digital', 'x': 1488, 'y': 561, 'width': 571, 'height': 68}, # A1 POV Switch up
        'Joy_17': {'Type': 'Digital', 'x': 1488, 'y': 795, 'width': 571, 'height': 68}, # A1 POV Switch right
        'Joy_18': {'Type': 'Digital', 'x': 1488, 'y': 638, 'width': 571, 'height': 68}, # A1 POV Switch down
        'Joy_19': {'Type': 'Digital', 'x': 1488, 'y': 717, 'width': 571, 'height': 68}, # A1 POV Switch left
        'Joy_20': {'Type': 'Digital', 'x': 1488, 'y': 875, 'width': 571, 'height': 68}, # A1 POV Switch press
        'Joy_XAxis': {'Type': 'Analogue', 'x': 2371, 'y': 2188, 'width': 930, 'height': 54}, # X axis
        'Joy_YAxis': {'Type': 'Analogue', 'x': 2371, 'y': 2131, 'width': 930, 'height': 54}, # Y axis
